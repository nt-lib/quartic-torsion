	...
	for d in [b: b in Divisors(n)|b lt n/2] do
		...
		if (degfp le 2) then 
			if deg gt 2 then 
				...
				else print "The degree 2 cusps force us to choose q which is in the subgroup of Z/",n div d, "\Z generated by ",p;
				end if;
...
for x in pairs do 
	print "The congruence conditions coming from degree 3 points for X_1(n) for n=", x[1], "are:";
	CC(x[1],x[2]);
end for;
...
for x in pairs do 
	print "The congruence conditions coming from degree 2 points for X_1(n) for n=", x[1], "are:";
